...
const PostPutMenuComponent = () => {
  ...
  var menu = { menuId, itemId, itemName, cost, numberOfItemsAvailable, date}

const addUpdateMenu = (e)=>{
  e.preventDefault()
  if(itemId){
    ...
    itemId = item_id
    menu = {menuId,itemId, itemName, cost, numberOfItemsAvailable, date}
    console.log(menu)
      ...
      <div className='card col-md-6 offset-md-3'>
        ...
        <div className='card-body'>
          ...
          <div class="row mt-3 mb-3">
            <div class="col-3">
                <label for="text">Menu Item Id:</label>
                <input type='text' class='form-control' placeholder='Enter Menu Id' name='menu_id'
                  value={item_id} onChange={(e) => setItem_Id(e.target.value)}>
                </input>
              </div>       
          <div class="col-3">
            ...
            <div class="col-3">
                ...
                <input type='text' class='form-control' placeholder='Enter Number of Items Available' name='numberOfItemsAvailable'
