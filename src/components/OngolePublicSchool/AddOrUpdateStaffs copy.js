...
const PostPutClassesComponent = () => {
  ...
  var classes = { classesId, uKg, lKg, firstClass, secondClass, thirdClass, fourthClass, fifthClass, sixthClass, seventhClass, eightClass, ninthClass, tenthClass  }
  ...
  const addOrEditClasses = (e) => {
    ...
    console.log(classes)
      ...
      classes = { classesId, uKg, lKg, firstClass, secondClass, thirdClass, fourthClass, fifthClass, sixthClass, seventhClass, eightClass, ninthClass, tenthClass }
      console.log(classes)
  ...
  useEffect(() => {
    if (classesId) {
      ClassesServices.getClassesByClassesId(classesId).then((response) => {
        setClasses_Id(response.data.classesId)
