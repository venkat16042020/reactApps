            ...
            <tbody>
          {
            records.map(
              ...
              <tr key={accountsMapObj.accountId}>
                ...
                <td>
                  <Link className='btn btn-outline-primary ms-1' to={`/updateAccount/${accountsMapObj.accountId}`}>Edit</Link>
                  <Link className='btn btn-outline-primary ms-1' to={`/deleteAccount/${accountsMapObj.accountId}`}>Delete</Link>
                </td>
                </tr>
            )
          }
